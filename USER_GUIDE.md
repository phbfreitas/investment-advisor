...
## 9. Portfolio Classification Engine
**Code Location:** `src/lib/classification.ts` (or similar engine)

This section outlines how the system uses a strict, rules-based decision tree to categorize assets. This approach prioritizes quantitative data (Yield and 3-Year Beta) from Yahoo Finance to ensure 100% alignment with your investment philosophy.
...
- **Asset Type**: Traditional "Dividend Aristocrats," REITs, Utilities, and major Financial Institutions.
...
- **Asset Type**: Covered Call ETFs (e.g., JEPQ, HDIV), high-yield closed-end funds (e.g., CLM).
